...
class DataIngestionConfig:
    ROOT_DIR: str = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../"))  # Subir 2 niveles desde src/components
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv(r'C:\Users\roser\OneDrive\Documentos\mlproject\notebook\data\stud.csv',encoding='utf-8')
